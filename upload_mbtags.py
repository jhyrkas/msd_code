...
columnNames = ['song_id', 'mbtag', 'count']
columnTypes = ['STRING_TYPE', 'STRING_TYPE', 'LONG_TYPE']
...
destination = myria.MyriaRelation("Jeremy:MSD:MBTagsTable", 
                            schema=schema,

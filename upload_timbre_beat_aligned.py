...
columnNames = ['song_id', 'beat_number'] + ['basis' + str(i) for i in range(12)]
columnTypes = ['STRING_TYPE', 'LONG_TYPE'] + ['DOUBLE_TYPE'] * 12
...
destination = myria.MyriaRelation("Jeremy:MSD:TimbreBeatAligned", 
                            schema=schema,
...
filename = 'timbre_beat_aligned_table.tsv'
upload_files = []
for i in range(1,27) :

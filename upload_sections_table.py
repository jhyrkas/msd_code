...
columnNames = ['song_id', 'section_number', 'section_start', 'section_confidence'
columnTypes = ['STRING_TYPE', 'LONG_TYPE', 'DOUBLE_TYPE', 'DOUBLE_TYPE']
...
destination = myria.MyriaRelation("Jeremy:MSD:SectionsTable", 
                            schema=schema,
